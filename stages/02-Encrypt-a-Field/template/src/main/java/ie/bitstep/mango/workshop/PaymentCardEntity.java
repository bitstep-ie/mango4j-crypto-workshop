...
public class PaymentCardEntity {
     ...
     * The field must stay `transient`, which the library enforces - it's
     * never meant to be serialized directly.
     */
    @Encrypt
     ...
     * This is where the resulting ciphertext gets written - it's the
     * field you'd actually persist (to a database, a file, wherever),
     * never cardNumber itself.
     */
    @EncryptedData

...
Before the hands-on stages, [The Talk](talk/01-what-is-ale.md) covers what Application-Level Encryption is, why it's needed, and the numerous ways the typical/naive approach fails in production.
